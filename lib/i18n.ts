...
export const es = {
  ...
  // ── Alta del agente ───────────────────────────────────────────────────────
  vinculaTuCuenta: "Vincular cuenta",
  introduceCodigoYCorreo: "Introduce el código de activación y tu correo electrónico.",
  codigoDeActivacion: "Código de activación",
  teLoDaElOperador: "Lo proporciona el Operador.",
  tuCorreo: "Tu correo",
  seraTuIdentificador: "Recibirás un código de verificación.",
...
const en: Cadenas = {
  ...
  vinculaTuCuenta: "Link account",
  introduceCodigoYCorreo: "Enter your activation code and email address.",
  codigoDeActivacion: "Activation code",
  teLoDaElOperador: "Provided by the Operator.",
  tuCorreo: "Your email",
  seraTuIdentificador: "You will receive a verification code.",
  enviarmeElCodigo: "Send code",
  confirmaQueEresTu: "Verify email",
  pideCodigo: "Enter your activation code.",
  otpEnviado: (email: string) =>
...
const it: Cadenas = {
  ...
  vinculaTuCuenta: "Collega account",
  introduceCodigoYCorreo: "Inserisci il codice di attivazione e la tua email.",
  codigoDeActivacion: "Codice di attivazione",
  teLoDaElOperador: "Te lo dà l'Operatore.",
  tuCorreo: "La tua email",
  seraTuIdentificador: "Riceverai un codice di verifica.",
  enviarmeElCodigo: "Invia codice",
  confirmaQueEresTu: "Verifica email",
  pideCodigo: "Inserisci il codice di attivazione.",
  otpEnviado: (email: string) =>
...
const pt: Cadenas = {
  ...
  vinculaTuCuenta: "Associar conta",
  introduceCodigoYCorreo: "Introduz o código de ativação e o teu email.",
  codigoDeActivacion: "Código de ativação",
  teLoDaElOperador: "É o Operador que to dá.",
  tuCorreo: "O teu email",
  seraTuIdentificador: "Vais receber um código de verificação.",
  enviarmeElCodigo: "Enviar código",
  confirmaQueEresTu: "Verificar email",
  pideCodigo: "Introduz o código de ativação.",
  otpEnviado: (email: string) =>
...
const ar: Cadenas = {
  ...
  introduceCodigoYCorreo: "أدخل رمز التفعيل وبريدك الإلكتروني.",
  codigoDeActivacion: "رمز التفعيل",
  teLoDaElOperador: "يعطيك إياه المشغّل.",
  tuCorreo: "بريدك الإلكتروني",
  seraTuIdentificador: "ستصلك رسالة برمز التحقق.",
